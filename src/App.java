...
public class App {
    public static void main(String[] args) throws Exception {
     ...
     private static void runEmpleadoExample() {
        EmpleadoContoller empC = new EmpleadoContoller();
        empC.addEmpleado(new Empleado(1, "Orlando", "Developer"));
        empC.addEmpleado(new Empleado(2, "Mia", "Teacher"));
        empC.addEmpleado(new Empleado(3, "Claudia", "Programmer"));
        empC.imprimirEmpleados();
